package com.geekster.WeeklyTest_6.controller;

import com.geekster.WeeklyTest_6.model.Student;
import com.geekster.WeeklyTest_6.service.StudentService;
...
public class StudentController {
    ...
    public ResponseEntity<String> saveStudent(@RequestBody String newStudent){
         ...
         return new ResponseEntity<>("Student save user id- "+studentId, HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<String> getStudentByName(@RequestParam String firstName){
